const jaJP = {
  ...
  pipelines: {
    ...
    pipeline: 'パイプライン',
    workflow: 'ワークフロー',
    pipelineDescription: 'メッセージ処理フロー',
    workflowDescription: 'ビジュアル自動化ワークフロー',
    createNewTitle: '新規作成',
    createNewDescription: '作成する自動化タイプを選択してください',
    noDescription: '説明なし',
    basicInfo: '基本情報',
    aiCapabilities: 'AI機能',
  ...
  workflow: {
    ...
    descriptionRequired: 'ワークフローの説明は必須です',
    createSuccess: 'ワークフローの作成に成功しました',
    createError: 'ワークフローの作成に失敗しました：',
    createDescription: '新しいワークフローの基本情報を入力してください',
    creating: '作成中...',
    saveSuccess: 'ワークフローの保存に成功しました',
    saveError: 'ワークフローの保存に失敗しました：',
    deleteConfirmation: '本当にこのワークフローを削除しますか？',
    deleteSuccess: 'ワークフローの削除に成功しました',
    ...
    nodePalette: 'ノードパレット',
    execute: '実行',
    executeSuccess: 'ワークフローの実行に成功しました。実行ID：{{id}}',
    executeFailed: 'ワークフローの実行に失敗しました',
    executeWorkflow: 'ワークフローを実行',
    loadFailed: 'ワークフローの読み込みに失敗しました',
    export: 'エクスポート',
    exportSuccess: 'ワークフローのエクスポートに成功しました',
    exportFailed: 'ワークフローのエクスポートに失敗しました',
    enterName: 'ワークフロー名を入力',
    enterDescription: 'ワークフローの説明を入力',
    debugDescription: 'デバッグモードではワークフローの実行をテストしてトラブルシューティングできます。',
    startDebugger: 'デバッガーを起動',
    categories: {
      start: '開始ノード',
      control: '制御フロー',
      action: 'アクション',
    ...
    nodes: {
      eventStart: 'イベント開始',
      eventStartDesc: 'メッセージイベントによってトリガーされます',
      replyMessage: '返信メッセージ',
      replyMessageDesc: '返信メッセージを送信',
      condition: '条件',
      conditionDesc: '条件に基づいてワークフローを分岐',
      httpRequest: 'HTTPリクエスト',
      httpRequestDesc: 'HTTPリクエストを実行',
    },
  },
  knowledge: {
    title: '知識ベース',
