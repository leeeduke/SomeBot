const zhHans = {
  ...
  pipelines: {
    ...
    pipeline: '流水线',
    workflow: '工作流',
    pipelineDescription: '消息处理流程',
    workflowDescription: '可视化自动化工作流',
    createNewTitle: '创建新的',
    createNewDescription: '选择要创建的自动化类型',
    noDescription: '暂无描述',
    basicInfo: '基础信息',
  ...
  workflow: {
    ...
    nodePalette: '节点面板',
    execute: '执行',
    executeSuccess: '工作流执行成功。执行ID：{{id}}',
    executeFailed: '工作流执行失败',
    executeWorkflow: '执行工作流',
    loadFailed: '加载工作流失败',
    export: '导出',
    exportSuccess: '工作流导出成功',
    exportFailed: '导出工作流失败',
    enterName: '输入工作流名称',
    enterDescription: '输入工作流描述',
    debugDescription: '调试模式允许您测试和排查工作流执行问题。',
    startDebugger: '启动调试器',
    categories: {
      start: '开始节点',
      control: '控制流',
    ...
    nodes: {
      eventStart: '事件开始',
      eventStartDesc: '由消息事件触发',
      replyMessage: '回复消息',
      replyMessageDesc: '发送回复消息',
      condition: '条件',
      conditionDesc: '基于条件分支工作流',
      httpRequest: 'HTTP请求',
      httpRequestDesc: '发起HTTP请求',
    },
  },
  knowledge: {
    title: '知识库',
