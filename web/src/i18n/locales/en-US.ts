const enUS = {
  ...
  pipelines: {
    ...
    pipeline: 'Pipeline',
    workflow: 'Workflow',
    pipelineDescription: 'Message processing flow',
    workflowDescription: 'Visual automation workflow',
    createNewTitle: 'Create New',
    createNewDescription: 'Choose what type of automation to create',
  ...
  workflow: {
    ...
    nameRequired: 'Workflow name cannot be empty',
    descriptionRequired: 'Workflow description cannot be empty',
    createSuccess: 'Workflow created successfully',
    createError: 'Workflow creation failed: ',
    createDescription: 'Enter basic information for your new workflow',
    creating: 'Creating...',
    saveSuccess: 'Workflow saved successfully',
    saveError: 'Workflow save failed: ',
    deleteConfirmation: 'Are you sure you want to delete this workflow?',
    deleteSuccess: 'Workflow deleted successfully',
    deleteError: 'Workflow delete failed: ',
    visualEditor: 'Visual Editor',
    settings: 'Settings',
    debug: 'Debug',
    nodePalette: 'Node Palette',
    execute: 'Execute',
    executeSuccess: 'Workflow executed successfully. Execution ID: {{id}}',
    ...
    enterDescription: 'Enter workflow description',
    debugDescription: 'Debug mode allows you to test and troubleshoot your workflow execution.',
    ...
    nodes: {
      ...
      eventStartDesc: 'Triggered by message events',
      replyMessage: 'Reply Message',
      replyMessageDesc: 'Send reply message',
      condition: 'Condition',
      conditionDesc: 'Branch workflow based on conditions',
      httpRequest: 'HTTP Request',
      httpRequestDesc: 'Make HTTP requests',
    },
  },
  knowledge: {
    title: 'Knowledge',
