const zhHant = {
  ...
  pipelines: {
    ...
    pipeline: '流程線',
    workflow: '工作流程',
    pipelineDescription: '訊息處理流程',
    workflowDescription: '視覺化自動化工作流程',
    createNewTitle: '建立新的',
    createNewDescription: '選擇要建立的自動化類型',
    noDescription: '暫無描述',
    basicInfo: '基本資訊',
  ...
  workflow: {
    ...
    nameRequired: '工作流程名稱不能為空',
    descriptionRequired: '工作流程描述不能為空',
    createSuccess: '工作流程建立成功',
    createError: '工作流程建立失敗：',
    createDescription: '輸入新工作流程的基本資訊',
    creating: '建立中...',
    saveSuccess: '工作流程儲存成功',
    saveError: '工作流程儲存失敗：',
    deleteConfirmation: '您確定要刪除這個工作流程嗎？',
    deleteSuccess: '工作流程刪除成功',
    deleteError: '工作流程刪除失敗：',
    visualEditor: '視覺化編輯器',
    settings: '設定',
    debug: '除錯',
    nodePalette: '節點面板',
    execute: '執行',
    executeSuccess: '工作流程執行成功。執行ID：{{id}}',
    executeFailed: '工作流程執行失敗',
    executeWorkflow: '執行工作流程',
    loadFailed: '載入工作流程失敗',
    export: '匯出',
    exportSuccess: '工作流程匯出成功',
    exportFailed: '匯出工作流程失敗',
    enterName: '輸入工作流程名稱',
    enterDescription: '輸入工作流程描述',
    debugDescription: '除錯模式允許您測試和排查工作流程執行問題。',
    startDebugger: '啟動除錯器',
    categories: {
      start: '開始節點',
      control: '控制流程',
    ...
    nodes: {
      eventStart: '事件開始',
      eventStartDesc: '由訊息事件觸發',
      replyMessage: '回覆訊息',
      replyMessageDesc: '傳送回覆訊息',
      condition: '條件',
      conditionDesc: '基於條件分支工作流程',
      httpRequest: 'HTTP請求',
      httpRequestDesc: '發起HTTP請求',
    },
  },
  knowledge: {
    title: '知識庫',
